...
def my_model(
    ...
    for k in readout_config_default:
        readout_config.setdefault(k, readout_config_default[k])
    ...
    set_random_seed(seed)
    grid_mean_predictor, grid_mean_predictor_type, source_grids = prepare_grid(readout_config['grid_mean_predictor'], dataloaders)
    readout_config['grid_mean_predictor'] = grid_mean_predictor

    core = my_Stacked2dCore(
        input_channels=core_input_channels,
        **core_config,
    )
